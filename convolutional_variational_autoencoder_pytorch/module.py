...
class Encoder(Module):
    def __init__(
        ...
        self.mu_out = nn.Conv2d(dim_latent, dim_latent, kernel_size=1, stride=1)
        self.logvar_out = nn.Conv2d(dim_latent, dim_latent, kernel_size=1, stride=1)
...
class Decoder(Module):
    def __init__(
        ...
        self.z_in = nn.Conv2d(dim_latent, dim_latent, kernel_size=1, stride=1)
